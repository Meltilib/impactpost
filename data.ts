...
export const EVENTS: Event[] = [
  { id: 'e1', title: 'Somali Independence Day Festival', date: 'Jul 01, 2:00 PM', location: 'Centennial Park, Etobicoke', type: 'Culture' },
  { id: 'e2', title: 'Diaspora Business Mixer', date: 'Nov 15, 6:00 PM', location: 'Metro Convention Centre', type: 'Networking' },
  { id: 'e3', title: 'Youth Mentorship Gala', date: 'Dec 10, 7:00 PM', location: 'Ottawa City Hall', type: 'Community' },
  { id: 'e4', title: 'Book Launch: "Nomad Chronicles"', date: 'Oct 30, 5:00 PM', location: 'Toronto Public Library', type: 'Literature' },
];