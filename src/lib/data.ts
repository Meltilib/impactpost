...
export const FEATURED_STORY: Story = {
  ...
  imageUrl: '/images/featured-story.jpg',
  author: {
    id: 'a1',
    name: 'Hodan Ali',
...
export const RECENT_STORIES: Story[] = [
  {
    ...
    category: 'Youth',
    imageUrl: '/images/story-tech-youth.jpg',
    author: { id: 'a2', name: 'Liban Farah', role: 'Youth Reporter', avatarUrl: '/images/avatar-2.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-22',
    readTime: '5 min read',
  ...
  },
  {
    ...
    category: 'Business',
    imageUrl: '/images/story-culinary.jpg',
    author: { id: 'a3', name: 'Sahra Mohamed', role: 'Culture Editor', avatarUrl: '/images/avatar-3.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-20',
    readTime: '6 min read',
  ...
  },
  {
    ...
    category: 'Culture',
    imageUrl: '/images/story-culture.jpg',
    author: { id: 'a4', name: 'Abdi Warsame', role: 'Contributor', avatarUrl: '/images/avatar-4.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-18',
    readTime: '8 min read',
  ...
  },
  {
    ...
    category: 'Wellness',
    imageUrl: '/images/story-wellness.jpg',
    author: { id: 'a5', name: 'Dr. Yasmin Elmi', role: 'Health Specialist', avatarUrl: '/images/avatar-5.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-15',
  ...
  },
  {
    ...
    category: 'Issues',
    imageUrl: '/images/story-global.jpg',
    author: { id: 'a1', name: 'Hodan Ali', role: 'Senior Correspondent', avatarUrl: '/images/avatar-1.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-12',
    readTime: '9 min read',
  ...
  },
  {
    ...
    category: 'Multimedia',
    imageUrl: '/images/story-documentary.jpg',
    author: { id: 'a6', name: 'Khadija Omar', role: 'Visual Journalist', avatarUrl: '/images/avatar-6.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-10',
  ...
  },
  {
    ...
    category: 'Business',
    imageUrl: '/images/story-finance.jpg',
    author: { id: 'a3', name: 'Sahra Mohamed', role: 'Culture Editor', avatarUrl: '/images/avatar-3.jpg' },
    photoCredit: 'Impact Post',
    date: '2024-10-08',
    readTime: '7 min read',
