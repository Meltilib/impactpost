...
function LocationItem(props) {
  ...
  let t7;
  $[16] !== node.href ? (t7 = /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, textOverflow: "ellipsis", children: node.href }), $[16] = node.href, $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== t6 || $[19] !== t7 ? (t8 = /* @__PURE__ */ jsxs(Flex, { gap: 3, children: [
    t5,
  ...
  let t9;
  return $[21] !== active || $[22] !== node.href || $[23] !== t3 || $[24] !== t4 || $[25] !== t8 ? (t9 = /* @__PURE__ */ jsx(Card, { ...t3, as: "a", onClick: t4, padding: 3, radius: 1, pressed: active, tone: "inherit", children: t8 }, node.href), $[21] = active, $[22] = node.href, $[23] = t3, $[24] = t4, $[25] = t8, $[26] = t9) : t9 = $[26], t9;
}
